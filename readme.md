### :sunflower: Attempt to create an NPM package to fetch quotes based on _various categories_ , explained by 'Bhagawad Gita' : Holy scripture which includes dialogues between Arjuna and Lord Krishna. 
